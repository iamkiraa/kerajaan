<?php  
 ...
 $query = "SELECT quest2, COUNT(*) AS number FROM feedback GROUP BY quest2";  
      ...
      <head>  
           ...
           {  
                var data = google.visualization.arrayToDataTable([  
                          ...
                          {  
                               echo "['".$row["quest2"]."', ".$row["number"]."],";  
                          }  
                          ?>  
                     ]);  
                var options = {  
                      title: '2. Adakah maklumat yang dikehendaki mudah untuk dicari?',  
                      //is3D:true,  
                      pieHole: 0.0
                     };  
