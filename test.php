...
$connect = new PDO("mysql:host=localhost;dbname=maklumbalas_db", "root", "");

$query = "SELECT quest1, COUNT(*) AS number FROM feedback GROUP BY quest1";
