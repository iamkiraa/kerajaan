...
<div class="content">
<h2>Kemaskini Maklumat Pengadu &raquo;</h2>
<hr />
<?php
...
header("Location: admProfile_cust.php");
}else{
...
<option value="<?php echo $row['custGender']; ?>"><?php echo $row['custGender']; ?></option>
...
<div class="col-sm-4">
<textarea name="custAddress" class="form-control" placeholder="Alamat"><?php echo $row ['custAddress']; ?></textarea>
</div>
</div>
...
<a href="admSearch_cust.php" class="btn btn-sm btn-danger" data-toggle="tooltip" title="Batal">Batal</a>
</div>
</div>
</form>
