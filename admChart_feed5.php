<?php  
 ...
 $query = "SELECT quest5, COUNT(*) AS number FROM feedback GROUP BY quest5";  
      ...
      <head>  
           ...
           {  
                var data = google.visualization.arrayToDataTable([  
                          ...
                          {  
                               echo "['".$row["quest5"]."', ".$row["number"]."],";  
                          }  
                          ?>  
                     ]);  
                var options = {  
                      title: '5. Kandungan/maklumat dalam Portal Terengganu menepati keperluan pengunjung?',  
                      //is3D:true,  
                      pieHole: 0.0
                     };  
